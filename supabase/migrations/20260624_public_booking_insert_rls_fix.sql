-- Fix staff business_id check scoping in public booking insert policy.
-- Without table qualification, business_id inside the subquery resolves to sm.business_id.
